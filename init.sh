...
echo "============================================================================="
echo "=                                                                           ="
echo "=  Login to JBoss BRMS to start developing rules projects, something like:  ="
echo "=                                                                           ="
echo "=  http://$HOST_IP:8080/business-central    ="
echo "=                                                                           ="
...
[root@workstation-6413 rhcs-destinasia-rules-demo]# ^C
[root@workstation-6413 rhcs-destinasia-rules-demo]# ^C
[root@workstation-6413 rhcs-destinasia-rules-demo]# ^C
[root@workstation-6413 rhcs-destinasia-rules-demo]# ^C
[root@workstation-6413 rhcs-destinasia-rules-demo]# cat init.sh
#!/bin/sh
DEMO="Destinasia Travel Rules Demo"
AUTHORS="Andrew Block, Eric D. Schabell, Woh Shon Phoon"
PROJECT="git@github.com:redhatdemocentral/rhcs-destinasia-rules-demo.git"
